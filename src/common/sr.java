...
public class sr {
	...
	public static void main() throws IOException {
		...
		FileReader fr=new FileReader("D:\\data\\srilekha\\edu\\sem5\\ir\\IR_1\\stopwords.txt\\");
        BufferedReader br= new BufferedReader(fr);
        while ((sCurrentLine = br.readLine()) != null){
        	stopWordsSet.add(sCurrentLine);
        }
		
		File dir = new File("D:\\data\\srilekha\\edu\\sem5\\ir\\IR_1\\inputfiles\\");
        ...
        for (File file : fList){
          ...
          //  System.out.println(file.getName());
            FileReader f=new FileReader("D:\\data\\srilekha\\edu\\sem5\\ir\\IR_1\\inputfiles\\"+file.getName());
           ...
           wordsList = StopRem(s);
    	    ...
    	    wordsList.clear();
    	    File file1 = new File("D:\\data\\srilekha\\edu\\sem5\\ir\\IR_1\\outputfiles\\"+file.getName());
